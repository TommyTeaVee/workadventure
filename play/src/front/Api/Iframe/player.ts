...
export class WorkadventurePlayerCommands extends IframeApiContribution<WorkadventurePlayerCommands> {
     ...
     * The token is generated by the administration panel linked to Qtune.
     * The token is a string and is depending on your implementation of the administration panel.
     * In Qtune SAAS version, the token is a JWT token that contains information such as the player's room ID and its associated membership ID.
     *
     * If you are using the self-hosted version of Qtune and you developed your own administration panel, the token can be anything.
     * By default, self-hosted versions of Qtune don't come with an administration panel, so the token string will be empty.
