...
Similarly, if you want to type messages from Qtune to the iframe, there is a very similar `IframeResponseEvent`.
...
In the Qtune code, each possible query should be handled by what we call an "answerer".
